<?php
	class SettingsFormProvider{
		...
		public function createPasswordForm(){
			...
			$newPasswordInput2 = $this->createPasswordInput("newPassword2", "Confirm new password");
		...
		private function createSaveUserDetailsButton(){
			return "<button type='submit' class='btn btn-primary' name='saveDetailButton'>Save</button>";
		}
